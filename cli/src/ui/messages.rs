...
pub const TIP_PEER_REMOVE_FIRST: &str = "remove the existing peer first with 'irosh peer remove'";
...
pub const TIP_DAEMON_STATUS: &str = "run 'irosh system status' to inspect the running daemon";
pub const TIP_DAEMON_WORMHOLE: &str = "run 'irosh system status' for daemon health details";
...
pub const TIP_WORMHOLE_TIMEOUT: &str = "wormhole codes expire after 60s — ask for a fresh one";
pub const TIP_WORMHOLE_CODE_LENGTH: &str = "use a longer code, or add a password with --passwd";
