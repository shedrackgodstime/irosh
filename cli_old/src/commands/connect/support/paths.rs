    ...
    for component in path.components() {
        match component {
            ...
            std::path::Component::ParentDir => {
                // Only pop if we have a component to pop, and it's not a root component
                // or a parent directory component itself (which shouldn't happen in normalized).
                // This prevents escaping the root of a relative path.
                normalized.pop();
            }
